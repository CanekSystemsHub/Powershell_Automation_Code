...
Switch ($True)
{
     $Domain.Contains('INFRA.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,16) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    }

    $Domain.Contains('LEARN.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,16) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    ...
    $Domain.Contains('OMCDS.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,16) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    ...
    $Domain.Contains('TBE.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,14) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    }

    $Domain.Contains('TECHNO.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,17) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    }

    $Domain.Contains('TEE.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,14) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    ...
    $Domain.Contains('TEE-PP.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,17) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()
    ...
    $Domain.Contains('OPCSVC.TALEOCLOUD.PRD')
    {
        $clientdomainnet = $clientdomainfqdn.substring(13,17) + ".NET"
        $clientdomaingroup = $ServerName + "$"
        $Podid = $ServerName.substring(6,1).ToLower()     
...
$PodValidation = [char]::IsNumber($clientDCtype) 


If ($PodValidation -eq "True")
{
	$proxy = $Datacenter +"proxy." +$clientdomainnet.ToLower()
}
Else
{
...
$proxyServerToDefine2 = "http=" +$proxy +":3128"
